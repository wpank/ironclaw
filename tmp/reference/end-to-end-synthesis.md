...
This synthesis summarizes the local end-to-end flow using captured-source
labels only as provenance. For the full walkthrough, use [end-to-end-flow.md](end-to-end-flow.md).
