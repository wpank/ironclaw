...
|----------|---------|----------|
| [Budget-Constrained Composition](budget-composition.md) | Prompt assembly that ranks memory, code, tools, skills, and history under a token budget. Uses density allocation, optional VCG-style displacement diagnostics, position-aware placement, and measured learning signals. | MEDIUM |
